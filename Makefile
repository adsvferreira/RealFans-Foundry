...
# "@" before "forge" in for avoiding print the full foundry command before execution
deploy:
	@forge script script/Deploy.s.sol:DeployRealFans $(NETWORK_ARGS)

# Example of command to deploy on sepolia:
